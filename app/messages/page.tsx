    ...
    <main className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid md:grid-cols-3 gap-6 h-[600px]">
          {/* Chat List */}
          <div className="md:col-span-1 bg-white rounded-lg border border-border flex flex-col">
            <div className="p-4 border-b border-border">
              <h2 className="text-lg font-semibold text-primary mb-4">Messages</h2>
          ...
          {/* Chat Window */}
          <div className="md:col-span-2 bg-white rounded-lg border border-border flex flex-col">
            {currentChat ? (
              <>
                {/* Chat Header */}
                <div className="p-4 border-b border-border flex items-center justify-between">
                  <div>
                    <h3 className="font-semibold text-primary">{currentChat.name}</h3>
                ...
                <div className="p-4 border-t border-border">
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-accent bg-input"
                    />
